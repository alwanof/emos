  ...
  data() {
    return {
      ...
      customer: {
        ...
        hotel_name: this.param.hotel_name ,
        room_no: this.param.room_no ,
        passport_no: this.param.passport_no ,
        dob: this.param.dob ,
  ...
  methods: {
    ...
    sendOrder() {
      ...
      order.customer = {
        ...
        hotel_name: this.customer.hotel_name ? this.customer.hotel_name : 0,
        room_no: this.customer.room_no ? this.customer.room_no : 0,
        passport_no: this.customer.passport_no ? this.customer.passport_no : 0,
        dob: this.customer.dob ? this.customer.dob : 0,
