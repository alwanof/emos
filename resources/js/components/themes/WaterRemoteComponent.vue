            ...
            <transition name="bounce">
                <div v-show="page==1">
                    <div class="row p-4 text-center justify-content-center">
                        <div class="col m-0 p-0" v-for="(cat,index) in cats" :key="cat.id">
                            <a href="#" v-scroll-to="'#cat-'+cat.id"  onclick="return false">
                                <img class="img-fluid" :src="path+'/assets/dist/img/water/'+index+'.png'" alt="">
                            </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="container-fluid" v-for="(feed,index1) in feeds" :key="feed.id" >
