                ...
                <div class="row">
                    <div class="col-sm-3 col-6">
                        <div class="description-block border-right">
                            <span class="description-percentage text-danger"><i class="fas fa-concierge-bell"></i> {{orders.amountYesterday}}</span>
                            <h5 class="description-header">₺{{orders.incomeYesterday}}</h5>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="description-block border-right">
                            <span class="description-percentage text-danger"><i class="fas fa-concierge-bell"></i> {{orders.amountLastwaek}}</span>
                            <h5 class="description-header">₺{{orders.incomeLastwaek}}</h5>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="description-block border-right">
                            <span class="description-percentage text-danger"><i class="fas fa-concierge-bell"></i> {{orders.amountLastmonth}}</span>
                            <h5 class="description-header">₺{{orders.incomeLastmonth}}</h5>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="description-block">
                            <span class="description-percentage text-danger"><i class="fas fa-concierge-bell"></i> {{orders.amountLastyear}}</span>
                            <h5 class="description-header">₺{{orders.incomeLastyear}}</h5>
    ...
    export default {
        ...
        created() {
            ...
            CONFIG.DB.collection('orders')
                .where('user.email','==',this.auth.email).get()
                .then(snapshot => {
                    snapshot.forEach(doc=>{
                        const firebaseDate=new Date(doc.data().timestamp.toDate()).toDateString();
