                                ...
                                <li class="item" v-for="(newOrder,index) in newOrders" :key="index">
                                    <div >
                                        ...
                                        <a href="javascript:void(0)" @click="exapandNew(newOrder)"  class="product-title" data-toggle="tooltip" title="Contacts" data-widget="chat-pane-toggle">
                                            #{{newOrder.orderID.substring(0, 4)}} <span class="text-danger"><i class="fas fa-barcode"></i> {{newOrder.customer.name.substring(0, 12)}}</span>
                                            <span class="badge badge-danger float-right">{{newOrder.total}}</span>
                                        </a>
                                        <span class="product-description" :title="newOrder.note">
                                            <i class="fas fa-phone-alt"></i>{{newOrder.customer.phone}}
                                            <i class="fas fa-map-marker-alt"></i> {{newOrder.customer.address}}
                                            <i class="far fa-comment"></i>{{newOrder.note}}
                                        </span>
                                ...
                                <li class="item" v-for="(waitingOrder,index) in waitingOrders" :key="index">
                                    <div >
                                        ...
                                        <a href="javascript:void(0)" @click="exapandWaiting(waitingOrder)"  class="product-title" data-toggle="tooltip" title="Contacts" data-widget="chat-pane-toggle">
                                            #{{waitingOrder.orderID.substring(0, 4)}} <span class="text-warning"><i class="fas fa-barcode"></i> {{waitingOrder.customer.name.substring(0, 12)}}</span>
                                            <span class="badge badge-warning float-right">{{waitingOrder.total}}</span>
                                        </a>
                                        <span class="product-description" :title="waitingOrder.note">
                                            <i class="fas fa-phone-alt"></i>{{waitingOrder.customer.phone}}
                                            <i class="fas fa-map-marker-alt"></i> {{waitingOrder.customer.address}}
                                            <i class="far fa-comment"></i>{{waitingOrder.note}}
                                        </span>
                                ...
                                <li class="item" v-for="(stabledOrder,index) in stabledOrders" :key="index">
                                    <div >
                                        <a href="javascript:void(0)" @click="exapandStabled(stabledOrder)"  class="product-title" data-toggle="tooltip" title="Contacts" data-widget="chat-pane-toggle">
                                            #{{stabledOrder.orderID.substring(0, 4)}} <span class="text-success"><i class="fas fa-barcode"></i> {{stabledOrder.customer.name.substring(0, 12)}}</span>
                                            <span class="badge badge-success float-right">{{stabledOrder.total}}</span>
                                        </a>
                                        <span class="product-description" :title="stabledOrder.note">
                                            <i class="fas fa-phone-alt"></i>{{stabledOrder.customer.phone}}
                                            <i class="fas fa-map-marker-alt"></i> {{stabledOrder.customer.address}}
                                            <i class="far fa-comment"></i>{{stabledOrder.note}}
                                        </span>
