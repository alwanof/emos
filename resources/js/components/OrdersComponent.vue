    ...
    <div class="row">
      <div class="col-md-4" v-show="acl.access_order_new">
        <div class="card direct-chat direct-chat-primary">
          <div
            class="card-header ui-sortable-handle bg-danger"
            style="cursor: move"
          >
          ...
          <div class="card-body">
            <div class="direct-chat-messages">
              <ul class="products-list product-list-in-card pl-2 pr-2">
                <li
                  class="item"
                  v-for="(newOrder, index) in newOrders"
                  :key="index"
                >
                  <div>
                    <span class="badge badge-danger">
                      ...
                      <span
                        :id="'norder-' + newOrder.orderID.substring(0, 10)"
                      ></span>
                    </span>
                    <a
      ...
      <div class="col-md-4" v-show="acl.access_order_waiting">
        <div class="card direct-chat direct-chat-primary">
          <div
            class="card-header ui-sortable-handle bg-warning"
            style="cursor: move"
          >
                ...
                >
                  <div>
                    <span class="badge badge-warning">
                      <span class="spinner-grow spinner-grow-sm"></span>
                      <span
                        :id="'worder-' + waitingOrder.orderID.substring(0, 10)"
                      ></span>
                    </span>
                    <a
                      href="javascript:void(0)"
          ...
          <div class="card-body">
            <div class="direct-chat-messages">
              <ul class="products-list product-list-in-card pl-2 pr-2">
                <li
                  class="item"
                  v-for="(stabledOrder, index) in stabledOrders"
                  :key="index"
                >
                  <div>
                    <a
