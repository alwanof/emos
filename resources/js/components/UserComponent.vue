<template>
    <div>
        <div class="row">
            ...
            <div :class="'card card-warning card-outline mx-1 col-lg-'+(11-roleSlide)" v-show="roleSlide==7">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clearFields() {
                this.user.name =this.user.id= this.user.email = this.user.password = null;
            }
        }
    };
</script>
